...
namespace Task\CreateCustomerAccountGraphQl\Model\Customer;
...
class ExtractCustomerData
{
    ...
    public function execute(CustomerInterface $customer): array
    {
        ...
        //put value of customer_company_name in customerData array
    //    var_dump($customerData);
//        if($customerData['customer_company_name'])
//            $customerData['customer_company_name'] = $customerData['customer_company_name'];
